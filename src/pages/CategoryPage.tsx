...
import { MapPin, Star, Clock, ShoppingCart } from 'lucide-react';
    ...
    <div className="bg-gray-50 min-h-screen py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8 flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900">{formattedCategoryName}</h1>
            <p className="text-gray-600 mt-1">Explore stores offering products in this category.</p>
          </div>
        </div>
